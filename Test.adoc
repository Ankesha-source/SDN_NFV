One of the salient characteristics of the digital revolution is the acceleration of change. Technologies that enabled the digital revolution over past decades experience ever-faster innovation cycles-for example, recall how rapidly mobile phone technology has advanced. And while it is a challenge to stay current with such accelerated changes, the advancements consistently deliver both operational and economic benefits. 
